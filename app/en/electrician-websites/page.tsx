...
const faqs = [
  {
    ...
    a: `Pixeloria electrician websites start at ${OFFERS_US.starter.price} for a one-page website. Multi-page websites with individual service pages start at ${OFFERS_US.growth.price}.`,
  },
  {
