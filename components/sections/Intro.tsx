      ...
      <div className="container">
        <div className="intro-content reveal">
          ...
          <p className="intro-body">
            Chaque site est pensé pour être clair, rapide, lisible sur mobile et adapté aux besoins
            réels d&apos;une petite entreprise&nbsp;: présenter vos services, rassurer vos prospects
