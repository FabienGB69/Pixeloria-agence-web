...
export default function sitemap(): MetadataRoute.Sitemap {
  return [
    ...
    { url: 'https://pixeloria.fr/en/free-website-audit', lastModified: new Date(), changeFrequency: 'monthly', priority: 0.85 },
    ...
    { url: 'https://pixeloria.fr/en/roofing-websites', lastModified: new Date(), changeFrequency: 'monthly', priority: 0.85 },
    { url: 'https://pixeloria.fr/en/landscaping-websites', lastModified: new Date(), changeFrequency: 'monthly', priority: 0.7 },
    { url: 'https://pixeloria.fr/en/painting-contractor-websites', lastModified: new Date(), changeFrequency: 'monthly', priority: 0.7 },
    { url: 'https://pixeloria.fr/en/general-contractor-websites', lastModified: new Date(), changeFrequency: 'monthly', priority: 0.7 },
    { url: 'https://pixeloria.fr/en/remodeling-contractor-websites', lastModified: new Date(), changeFrequency: 'monthly', priority: 0.7 },
    { url: 'https://pixeloria.fr/en/gutter-company-websites', lastModified: new Date(), changeFrequency: 'monthly', priority: 0.7 },
    { url: 'https://pixeloria.fr/en/hvac-websites', lastModified: new Date(), changeFrequency: 'monthly', priority: 0.7 },
    { url: 'https://pixeloria.fr/en/resources', lastModified: new Date(), changeFrequency: 'monthly', priority: 0.7 },
    { url: 'https://pixeloria.fr/en/resources/contractor-website-guide', lastModified: new Date(), changeFrequency: 'monthly', priority: 0.65 },
    { url: 'https://pixeloria.fr/en/resources/contractor-website-cost', lastModified: new Date(), changeFrequency: 'monthly', priority: 0.65 },
    { url: 'https://pixeloria.fr/en/resources/contractor-website-examples', lastModified: new Date(), changeFrequency: 'monthly', priority: 0.65 },
    { url: 'https://pixeloria.fr/en/case-studies', lastModified: new Date(), changeFrequency: 'monthly', priority: 0.8 },
    { url: 'https://pixeloria.fr/en/contractor-websites', lastModified: new Date(), changeFrequency: 'monthly', priority: 0.85 },
    { url: 'https://pixeloria.fr/en/contractor-websites/georgia', lastModified: new Date(), changeFrequency: 'monthly', priority: 0.6 },
    { url: 'https://pixeloria.fr/en/contractor-websites/colorado', lastModified: new Date(), changeFrequency: 'monthly', priority: 0.6 },
    { url: 'https://pixeloria.fr/en/contractor-websites/texas', lastModified: new Date(), changeFrequency: 'monthly', priority: 0.6 },
    { url: 'https://pixeloria.fr/en/contractor-websites/florida', lastModified: new Date(), changeFrequency: 'monthly', priority: 0.6 },
    { url: 'https://pixeloria.fr/en/contractor-websites/north-carolina', lastModified: new Date(), changeFrequency: 'monthly', priority: 0.6 },
    { url: 'https://pixeloria.fr/en/home-service-websites', lastModified: new Date(), changeFrequency: 'monthly', priority: 0.85 },
    { url: 'https://pixeloria.fr/en/plumber-websites', lastModified: new Date(), changeFrequency: 'monthly', priority: 0.7 },
    { url: 'https://pixeloria.fr/en/electrician-websites', lastModified: new Date(), changeFrequency: 'monthly', priority: 0.7 },
